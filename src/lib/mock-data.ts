...
export const mockSubscriptions = [
    { id: '1', subscriber_id: '1', plan_id: '1', price: 25000, status: 'active', payment_status: 'paid', start_date: addDays(-30), end_date: addDays(0), subscriber: mockSubscribers[0], plan: mockPlans[0] },
    { id: '2', subscriber_id: '2', plan_id: '2', price: 50000, status: 'active', payment_status: 'paid', start_date: addDays(-25), end_date: addDays(5), subscriber: mockSubscribers[1], plan: mockPlans[1] },
    { id: '3', subscriber_id: '3', plan_id: '1', price: 25000, status: 'active', payment_status: 'unpaid', start_date: addDays(-20), end_date: addDays(10), subscriber: mockSubscribers[2], plan: mockPlans[0] },
    { id: '4', subscriber_id: '4', plan_id: '3', price: 250000, status: 'expired', payment_status: 'paid', start_date: addDays(-400), end_date: addDays(-35), subscriber: mockSubscribers[3], plan: mockPlans[2] },
    { id: '5', subscriber_id: '5', plan_id: '2', price: 50000, status: 'active', payment_status: 'unpaid', start_date: addDays(-15), end_date: addDays(15), subscriber: mockSubscribers[4], plan: mockPlans[1] },
    { id: '6', subscriber_id: '6', plan_id: '4', price: 500000, status: 'active', payment_status: 'paid', start_date: addDays(-100), end_date: addDays(265), subscriber: mockSubscribers[5], plan: mockPlans[3] },
    { id: '7', subscriber_id: '7', plan_id: '1', price: 25000, status: 'active', payment_status: 'paid', start_date: addDays(-10), end_date: addDays(20), subscriber: mockSubscribers[6], plan: mockPlans[0] },
    { id: '8', subscriber_id: '8', plan_id: '5', price: 10000, status: 'active', payment_status: 'unpaid', start_date: addDays(-5), end_date: addDays(2), subscriber: mockSubscribers[7], plan: mockPlans[4] },
];
